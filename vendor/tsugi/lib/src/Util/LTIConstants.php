...
class LTIConstants {
    ...
    * The Tool Provider should be flexible when parsing this field.  This parameter is optional but recommended.
	 ...
	 */
	const ACCEPT_MEDIA_TYPES = "accept_media_types";

    const MEDIA_LTILINKITEM = "application/vnd.ims.lti.v1.ltilink";
	 ...
	 */
	const ACCEPT_PRESENTATION_DOCUMENT_TARGETS = "accept_presentation_document_targets";
	 ...
	 */
	const CONTENT_ITEM_RETURN_URL = "content_item_return_url";
	 ...
	 */
	const ACCEPT_UNSIGNED = "accept_unsigned";
	 ...
	 */
	const ACCEPT_MULTIPLE = "accept_multiple";
	 ...
	 */
	const ACCEPT_COPY_ADVICE = "accept_copy_advice";
	 ...
	 */
	const EXT_SAKAI_PROVIDER_EID = "ext_sakai_provider_eid";
	 ...
	 * This parameter is optional and is unique to the Sakai Basic LTI provider.
	 */
	const EXT_SAKAI_PROVIDER_DISPLAYID = "ext_sakai_provider_displayid";
    ...
    const TYPE_LTILINKITEM = "LtiLinkItem";
    const TYPE_LTILINK_OLD = "LtiLink";
    const TYPE_CONTENTITEM = "ContentItem";
    ...
    const LTI_MESSAGE_TYPE_CONTEXTMEMBERSHIPSWITHGROUPS = "basic-lis-readmembershipsforcontextwithgroups";
