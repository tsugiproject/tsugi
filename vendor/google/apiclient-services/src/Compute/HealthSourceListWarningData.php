...
class HealthSourceListWarningData extends \Google\Model
{
  /**
...
class_alias(HealthSourceListWarningData::class, 'Google_Service_Compute_HealthSourceListWarningData');
