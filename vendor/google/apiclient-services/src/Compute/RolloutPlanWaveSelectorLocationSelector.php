...
class RolloutPlanWaveSelectorLocationSelector extends \Google\Collection
{
...
class_alias(RolloutPlanWaveSelectorLocationSelector::class, 'Google_Service_Compute_RolloutPlanWaveSelectorLocationSelector');
