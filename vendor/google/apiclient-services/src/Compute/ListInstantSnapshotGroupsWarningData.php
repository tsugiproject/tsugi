...
class ListInstantSnapshotGroupsWarningData extends \Google\Model
{
  /**
...
class_alias(ListInstantSnapshotGroupsWarningData::class, 'Google_Service_Compute_ListInstantSnapshotGroupsWarningData');
