...
class HealthAggregationPolicyListWarningData extends \Google\Model
{
  /**
...
class_alias(HealthAggregationPolicyListWarningData::class, 'Google_Service_Compute_HealthAggregationPolicyListWarningData');
