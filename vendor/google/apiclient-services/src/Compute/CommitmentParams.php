...
class CommitmentParams extends \Google\Model
{
  /**
   * Input only. Resource manager tags to be bound to the commitment. Tag keys
...
class_alias(CommitmentParams::class, 'Google_Service_Compute_CommitmentParams');
