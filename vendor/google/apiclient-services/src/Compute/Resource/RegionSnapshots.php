...
use Google\Service\Compute\RegionSnapshotUpdateKmsKeyRequest;
 ...
 *   $regionSnapshots = $computeService->regionSnapshots;
 *  </code>
 */
class RegionSnapshots extends \Google\Service\Resource
{
  /**
   ...
   *
   * For more information, seeDeleting snapshots. (regionSnapshots.delete)
   *
   ...
   */
  public function delete($project, $region, $snapshot, $optParams = [])
  {
    $params = ['project' => $project, 'region' => $region, 'snapshot' => $snapshot];
    $params = array_merge($params, $optParams);
    return $this->call('delete', [$params], Operation::class);
  }
  /**
   * Returns the specified Snapshot resource. (regionSnapshots.get)
   *
   * @param string $project Project ID for this request.
   ...
   * @throws \Google\Service\Exception
   */
  public function get($project, $region, $snapshot, $optParams = [])
  {
    $params = ['project' => $project, 'region' => $region, 'snapshot' => $snapshot];
    $params = array_merge($params, $optParams);
   ...
   * or resource exists. (regionSnapshots.getIamPolicy)
   *
   * @param string $project Project ID for this request.
   * @param string $region The name of the region for this request.
   ...
   * request. (regionSnapshots.insert)
   *
   * @param string $project Project ID for this request.
   * @param string $region Name of the region for this request.
   ...
   * @throws \Google\Service\Exception
   */
  public function insert($project, $region, Snapshot $postBody, $optParams = [])
  {
   ...
   * region. (regionSnapshots.listRegionSnapshots)
   *
   * @param string $project Project ID for this request.
   * @param string $region Name of the region for this request.
   * @param array $optParams Optional parameters.
   ...
   * @throws \Google\Service\Exception
   */
  public function listRegionSnapshots($project, $region, $optParams = [])
  {
   ...
   * existing policy. (regionSnapshots.setIamPolicy)
   *
   * @param string $project Project ID for this request.
   * @param string $region The name of the region for this request.
   * @param string $resource Name or id of the resource for this request.
   ...
   * Labeling Resources documentation. (regionSnapshots.setLabels)
   *
   * @param string $project Project ID for this request.
   ...
   * specified snapshot. (regionSnapshots.updateKmsKey)
   *
   * @param string $project Project ID for this request.
   * @param string $region Name of the region for this request.
   * @param string $snapshot Name of the snapshot resource to update. Should
   * conform to RFC1035.
   * @param RegionSnapshotUpdateKmsKeyRequest $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param string requestId An optional request ID to identify requests.
   * Specify a unique request ID so that if you must retry your request, the
   ...
   * @throws \Google\Service\Exception
   */
  public function updateKmsKey($project, $region, $snapshot, RegionSnapshotUpdateKmsKeyRequest $postBody, $optParams = [])
  {
    $params = ['project' => $project, 'region' => $region, 'snapshot' => $snapshot, 'postBody' => $postBody];
    $params = array_merge($params, $optParams);
...
class_alias(RegionSnapshots::class, 'Google_Service_Compute_Resource_RegionSnapshots');
