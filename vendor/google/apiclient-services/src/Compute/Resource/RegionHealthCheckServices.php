...
use Google\Service\Compute\HealthCheckServiceAggregatedList;
...
class RegionHealthCheckServices extends \Google\Service\Resource
{
   ...
   * parameter to `true`. (regionHealthCheckServices.aggregatedList)
   *
  ...
  public function aggregatedList($project, $optParams = [])
  {
    ...
    return $this->call('aggregatedList', [$params], HealthCheckServiceAggregatedList::class);
  }
  /**
