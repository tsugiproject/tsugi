 ...
 *   $regionSnapshotSettings = $computeService->regionSnapshotSettings;
 *  </code>
 */
class RegionSnapshotSettings extends \Google\Service\Resource
{
  ...
  /**
   * Patch region snapshot settings. (regionSnapshotSettings.patch)
   *
   * @param string $project Project ID for this request.
   * @param string $region Name of the region for this request.
   ...
   * @throws \Google\Service\Exception
   */
  public function patch($project, $region, SnapshotSettingsModel $postBody, $optParams = [])
  {
...
class_alias(RegionSnapshotSettings::class, 'Google_Service_Compute_Resource_RegionSnapshotSettings');
