...
use Google\Service\Compute\BackendBucketListUsable;
 ...
 *   $regionBackendBuckets = $computeService->regionBackendBuckets;
 *  </code>
 */
class RegionBackendBuckets extends \Google\Service\Resource
{
   ...
   */
  public function delete($project, $region, $backendBucket, $optParams = [])
  {
    $params = ['project' => $project, 'region' => $region, 'backendBucket' => $backendBucket];
    $params = array_merge($params, $optParams);
    return $this->call('delete', [$params], Operation::class);
  }
  /**
   * Returns the specified regional BackendBucket resource.
   * (regionBackendBuckets.get)
   *
   * @param string $project Project ID for this request.
   * @param string $region Name of the region scoping this request.
   ...
   * @throws \Google\Service\Exception
   */
  public function get($project, $region, $backendBucket, $optParams = [])
  {
    $params = ['project' => $project, 'region' => $region, 'backendBucket' => $backendBucket];
    $params = array_merge($params, $optParams);
   ...
   * or resource exists. (regionBackendBuckets.getIamPolicy)
   *
   * @param string $project Project ID for this request.
   ...
   * @throws \Google\Service\Exception
   */
  public function insert($project, $region, BackendBucket $postBody, $optParams = [])
  {
   ...
   * project in the given region. (regionBackendBuckets.listRegionBackendBuckets)
   *
   * @param string $project Project ID for this request.
   * @param string $region Name of the region of this request.
   * @param array $optParams Optional parameters.
   ...
   * @throws \Google\Service\Exception
   */
  public function listRegionBackendBuckets($project, $region, $optParams = [])
  {
   ...
   * the given region. (regionBackendBuckets.listUsable)
   *
   * @param string $project Project ID for this request.
  ...
  public function listUsable($project, $region, $optParams = [])
  {
    $params = ['project' => $project, 'region' => $region];
    $params = array_merge($params, $optParams);
    return $this->call('listUsable', [$params], BackendBucketListUsable::class);
  }
  /**
   * Updates the specified  BackendBucket resource with the data included in the
   * request. This method supportsPATCH semantics and uses theJSON merge patch
   * format and processing rules. (regionBackendBuckets.patch)
   *
   * @param string $project Project ID for this request.
   * @param string $region Name of the region scoping this request.
   ...
   * @throws \Google\Service\Exception
   */
  public function patch($project, $region, $backendBucket, BackendBucket $postBody, $optParams = [])
  {
    $params = ['project' => $project, 'region' => $region, 'backendBucket' => $backendBucket, 'postBody' => $postBody];
    $params = array_merge($params, $optParams);
    return $this->call('patch', [$params], Operation::class);
  }
  /**
   * Sets the access control policy on the specified resource. Replaces any
   * existing policy. (regionBackendBuckets.setIamPolicy)
   *
   * @param string $project Project ID for this request.
   * @param string $region The name of the region for this request.
   * @param string $resource Name or id of the resource for this request.
...
class_alias(RegionBackendBuckets::class, 'Google_Service_Compute_Resource_RegionBackendBuckets');
