...
use Google\Service\Compute\RolloutPlan;
use Google\Service\Compute\RolloutPlansListResponse;

/**
 * The "rolloutPlans" collection of methods.
 * Typical usage is:
 *  <code>
 *   $computeService = new Google\Service\Compute(...);
 *   $rolloutPlans = $computeService->rolloutPlans;
 *  </code>
 */
class RolloutPlans extends \Google\Service\Resource
{
  /**
   * Deletes a RolloutPlan. (rolloutPlans.delete)
   *
   ...
   */
  public function delete($project, $rolloutPlan, $optParams = [])
  {
    $params = ['project' => $project, 'rolloutPlan' => $rolloutPlan];
    $params = array_merge($params, $optParams);
    return $this->call('delete', [$params], Operation::class);
  }
  /**
   * Gets details of a single project-scoped RolloutPlan. (rolloutPlans.get)
   *
   * @param string $project Project ID for this request.
   ...
   * @throws \Google\Service\Exception
   */
  public function get($project, $rolloutPlan, $optParams = [])
  {
    $params = ['project' => $project, 'rolloutPlan' => $rolloutPlan];
    $params = array_merge($params, $optParams);
    return $this->call('get', [$params], RolloutPlan::class);
  }
  /**
   ...
   * @throws \Google\Service\Exception
   */
  public function insert($project, RolloutPlan $postBody, $optParams = [])
  {
   ...
   * with an error code.
   * @return RolloutPlansListResponse
   * @throws \Google\Service\Exception
   */
  public function listRolloutPlans($project, $optParams = [])
  {
    $params = ['project' => $project];
    $params = array_merge($params, $optParams);
    return $this->call('list', [$params], RolloutPlansListResponse::class);
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(RolloutPlans::class, 'Google_Service_Compute_Resource_RolloutPlans');
