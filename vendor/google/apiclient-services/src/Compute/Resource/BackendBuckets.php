...
use Google\Service\Compute\BackendBucketAggregatedList;
...
class BackendBuckets extends \Google\Service\Resource
{
   ...
   * parameter to `true`. (backendBuckets.aggregatedList)
   *
  ...
  public function aggregatedList($project, $optParams = [])
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('aggregatedList', [$params], BackendBucketAggregatedList::class);
  }
  /**
