...
class ReservationSlotPhysicalTopology extends \Google\Model
{
  /**
...
class_alias(ReservationSlotPhysicalTopology::class, 'Google_Service_Compute_ReservationSlotPhysicalTopology');
