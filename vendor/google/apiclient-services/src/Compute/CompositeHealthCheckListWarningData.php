...
class CompositeHealthCheckListWarningData extends \Google\Model
{
  /**
...
class_alias(CompositeHealthCheckListWarningData::class, 'Google_Service_Compute_CompositeHealthCheckListWarningData');
