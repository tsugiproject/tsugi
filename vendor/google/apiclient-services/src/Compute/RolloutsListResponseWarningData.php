...
class RolloutsListResponseWarningData extends \Google\Model
{
  /**
...
class_alias(RolloutsListResponseWarningData::class, 'Google_Service_Compute_RolloutsListResponseWarningData');
