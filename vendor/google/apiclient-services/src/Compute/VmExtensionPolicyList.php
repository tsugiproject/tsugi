...
class VmExtensionPolicyList extends \Google\Collection
{
   ...
   * This field will be ignored when inserting a VmExtensionPolicy. An up-to-
   * date fingerprint must be provided in order to update the VmExtensionPolicy.
   *
   ...
   */
  public $id;
  protected $itemsType = VmExtensionPolicy::class;
   ...
   */
  public $unreachables;
  protected $warningType = VmExtensionPolicyListWarning::class;
   ...
   *
   * @param VmExtensionPolicyListWarning $warning
   */
  public function setWarning(VmExtensionPolicyListWarning $warning)
  {
    $this->warning = $warning;
  }
  /**
   * @return VmExtensionPolicyListWarning
   */
...
class_alias(VmExtensionPolicyList::class, 'Google_Service_Compute_VmExtensionPolicyList');
