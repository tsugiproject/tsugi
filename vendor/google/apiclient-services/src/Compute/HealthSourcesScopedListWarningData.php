...
class HealthSourcesScopedListWarningData extends \Google\Model
{
  /**
...
class_alias(HealthSourcesScopedListWarningData::class, 'Google_Service_Compute_HealthSourcesScopedListWarningData');
