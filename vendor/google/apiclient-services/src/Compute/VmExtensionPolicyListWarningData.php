...
class VmExtensionPolicyListWarningData extends \Google\Model
{
  /**
...
class_alias(VmExtensionPolicyListWarningData::class, 'Google_Service_Compute_VmExtensionPolicyListWarningData');
