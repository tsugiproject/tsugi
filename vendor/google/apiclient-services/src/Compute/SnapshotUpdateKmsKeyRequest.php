...
class SnapshotUpdateKmsKeyRequest extends \Google\Model
{
  /**
...
class_alias(SnapshotUpdateKmsKeyRequest::class, 'Google_Service_Compute_SnapshotUpdateKmsKeyRequest');
