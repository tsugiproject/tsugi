...
class GlobalVmExtensionPolicyListWarningData extends \Google\Model
{
  /**
...
class_alias(GlobalVmExtensionPolicyListWarningData::class, 'Google_Service_Compute_GlobalVmExtensionPolicyListWarningData');
