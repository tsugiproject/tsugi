...
class HealthSourceAggregatedListWarningData extends \Google\Model
{
  /**
...
class_alias(HealthSourceAggregatedListWarningData::class, 'Google_Service_Compute_HealthSourceAggregatedListWarningData');
