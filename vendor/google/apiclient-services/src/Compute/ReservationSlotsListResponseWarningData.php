...
class ReservationSlotsListResponseWarningData extends \Google\Model
{
  /**
...
class_alias(ReservationSlotsListResponseWarningData::class, 'Google_Service_Compute_ReservationSlotsListResponseWarningData');
