...
class RolloutPlansListResponseWarningData extends \Google\Model
{
  /**
...
class_alias(RolloutPlansListResponseWarningData::class, 'Google_Service_Compute_RolloutPlansListResponseWarningData');
