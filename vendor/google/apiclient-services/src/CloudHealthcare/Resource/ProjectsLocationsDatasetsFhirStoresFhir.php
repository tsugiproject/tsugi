...
class ProjectsLocationsDatasetsFhirStoresFhir extends \Google\Service\Resource
{
   ...
   * identifier=system|value or identifier=value - similar to the search method on
   ...
   * want to keep the default sorting order. For samples and detailed information,
