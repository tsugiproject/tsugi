...
class GoogleChromeManagementVersionsV1CrowdStrikeFalconNextGenConfig extends \Google\Model
{
  /**
  ...
  /**
   * Required. The reporting settings for the CrowdStrike Falcon Next Gen
   * config.
   *
...
class_alias(GoogleChromeManagementVersionsV1CrowdStrikeFalconNextGenConfig::class, 'Google_Service_ChromeManagement_GoogleChromeManagementVersionsV1CrowdStrikeFalconNextGenConfig');
