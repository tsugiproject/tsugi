...
class SqlServerDestinationConfig extends \Google\Model
{
  /**
...
class_alias(SqlServerDestinationConfig::class, 'Google_Service_DatabaseMigrationService_SqlServerDestinationConfig');
