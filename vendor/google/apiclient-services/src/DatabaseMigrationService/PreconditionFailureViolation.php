...
class PreconditionFailureViolation extends \Google\Model
{
  /**
...
class_alias(PreconditionFailureViolation::class, 'Google_Service_DatabaseMigrationService_PreconditionFailureViolation');
