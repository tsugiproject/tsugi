...
class GoogleCloudDialogflowV2beta1TelephonyDtmfEvents extends \Google\Collection
{
  ...
  {
    return $this->dtmfEvents;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudDialogflowV2beta1TelephonyDtmfEvents::class, 'Google_Service_Dialogflow_GoogleCloudDialogflowV2beta1TelephonyDtmfEvents');
