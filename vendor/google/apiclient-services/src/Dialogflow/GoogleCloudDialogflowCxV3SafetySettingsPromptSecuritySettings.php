...
class GoogleCloudDialogflowCxV3SafetySettingsPromptSecuritySettings extends \Google\Model
{
  ...
  {
    return $this->enablePromptSecurity;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudDialogflowCxV3SafetySettingsPromptSecuritySettings::class, 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3SafetySettingsPromptSecuritySettings');
