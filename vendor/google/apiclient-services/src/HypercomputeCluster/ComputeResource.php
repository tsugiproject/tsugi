...
{
  protected $configType = ComputeResourceConfig::class;
   ...
   *
   * @param ComputeResourceConfig $config
   */
  public function setConfig(ComputeResourceConfig $config)
  {
    $this->config = $config;
  }
  /**
...
class_alias(ComputeResource::class, 'Google_Service_HypercomputeCluster_ComputeResource');
