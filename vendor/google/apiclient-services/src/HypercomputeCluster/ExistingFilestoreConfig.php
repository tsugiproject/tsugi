...
class ExistingFilestoreConfig extends \Google\Model
{
  /**
...
class_alias(ExistingFilestoreConfig::class, 'Google_Service_HypercomputeCluster_ExistingFilestoreConfig');
