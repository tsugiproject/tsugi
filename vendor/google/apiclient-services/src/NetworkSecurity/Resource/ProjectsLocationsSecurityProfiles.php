 ...
 *   $securityProfiles = $networksecurityService->projects_locations_securityProfiles;
 *  </code>
 */
class ProjectsLocationsSecurityProfiles extends \Google\Service\Resource
{
  /**
   ...
   * (securityProfiles.listProjectsLocationsSecurityProfiles)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsSecurityProfiles($parent, $optParams = [])
  {
...
class_alias(ProjectsLocationsSecurityProfiles::class, 'Google_Service_NetworkSecurity_Resource_ProjectsLocationsSecurityProfiles');
