 ...
 *   $securityProfileGroups = $networksecurityService->projects_locations_securityProfileGroups;
 *  </code>
 */
class ProjectsLocationsSecurityProfileGroups extends \Google\Service\Resource
{
  /**
   ...
   * (securityProfileGroups.listProjectsLocationsSecurityProfileGroups)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsSecurityProfileGroups($parent, $optParams = [])
  {
...
class_alias(ProjectsLocationsSecurityProfileGroups::class, 'Google_Service_NetworkSecurity_Resource_ProjectsLocationsSecurityProfileGroups');
