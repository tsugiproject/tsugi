...
class Organizations extends \Google\Service\Resource
{
   ...
   * encryption) for more information. (organizations.getCmekSettings)
   *
   ...
   * settings) for more information. (organizations.getSettings)
   *
   ...
   * more information. (organizations.updateCmekSettings)
   *
