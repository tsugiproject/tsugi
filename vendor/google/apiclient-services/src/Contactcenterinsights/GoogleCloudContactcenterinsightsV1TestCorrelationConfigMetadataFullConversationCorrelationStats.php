...
class GoogleCloudContactcenterinsightsV1TestCorrelationConfigMetadataFullConversationCorrelationStats extends \Google\Collection
{
  protected $collection_key = 'partialErrors';
  protected $conversationCorrelationErrorsType = GoogleCloudContactcenterinsightsV1TestCorrelationConfigMetadataFullConversationCorrelationStatsConversationCorrelationError::class;
   ...
   *
   * @param GoogleCloudContactcenterinsightsV1TestCorrelationConfigMetadataFullConversationCorrelationStatsConversationCorrelationError[] $conversationCorrelationErrors
   */
  ...
  /**
   * @return GoogleCloudContactcenterinsightsV1TestCorrelationConfigMetadataFullConversationCorrelationStatsConversationCorrelationError[]
   */
...
class_alias(GoogleCloudContactcenterinsightsV1TestCorrelationConfigMetadataFullConversationCorrelationStats::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1TestCorrelationConfigMetadataFullConversationCorrelationStats');
