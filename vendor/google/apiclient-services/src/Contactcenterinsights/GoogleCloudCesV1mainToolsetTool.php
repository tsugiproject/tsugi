...
class GoogleCloudCesV1mainToolsetTool extends \Google\Model
{
  /**
...
class_alias(GoogleCloudCesV1mainToolsetTool::class, 'Google_Service_Contactcenterinsights_GoogleCloudCesV1mainToolsetTool');
