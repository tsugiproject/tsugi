...
class GoogleCloudContactcenterinsightsV1LossPatternLink extends \Google\Model
{
  /**
  ...
  protected $botInstructionLinkType = GoogleCloudContactcenterinsightsV1LossPatternLinkBotInstructionLink::class;
  protected $botInstructionLinkDataType = '';
  protected $conversationLinkType = GoogleCloudContactcenterinsightsV1LossPatternLinkConversationLink::class;
   ...
   *
   * @param GoogleCloudContactcenterinsightsV1LossPatternLinkBotInstructionLink $botInstructionLink
   */
  public function setBotInstructionLink(GoogleCloudContactcenterinsightsV1LossPatternLinkBotInstructionLink $botInstructionLink)
  {
    $this->botInstructionLink = $botInstructionLink;
  }
  /**
   * @return GoogleCloudContactcenterinsightsV1LossPatternLinkBotInstructionLink
   */
   ...
   *
   * @param GoogleCloudContactcenterinsightsV1LossPatternLinkConversationLink $conversationLink
   */
  public function setConversationLink(GoogleCloudContactcenterinsightsV1LossPatternLinkConversationLink $conversationLink)
  {
    $this->conversationLink = $conversationLink;
  }
  /**
   * @return GoogleCloudContactcenterinsightsV1LossPatternLinkConversationLink
   */
...
class_alias(GoogleCloudContactcenterinsightsV1LossPatternLink::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1LossPatternLink');
