...
class GoogleCloudContactcenterinsightsV1alpha1GenerativeInsightsResponseGenerativeResponse extends \Google\Model
{
  /**
  ...
  protected $textMessageType = GoogleCloudContactcenterinsightsV1alpha1GenerativeInsightsResponseGenerativeResponseTextOutput::class;
   ...
   * THOUGHT or a FINAL response or some in-progress response.
   *
   * @param GoogleCloudContactcenterinsightsV1alpha1GenerativeInsightsResponseGenerativeResponseTextOutput $textMessage
   */
  public function setTextMessage(GoogleCloudContactcenterinsightsV1alpha1GenerativeInsightsResponseGenerativeResponseTextOutput $textMessage)
  {
    $this->textMessage = $textMessage;
  }
  /**
   * @return GoogleCloudContactcenterinsightsV1alpha1GenerativeInsightsResponseGenerativeResponseTextOutput
   */
...
class_alias(GoogleCloudContactcenterinsightsV1alpha1GenerativeInsightsResponseGenerativeResponse::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1alpha1GenerativeInsightsResponseGenerativeResponse');
