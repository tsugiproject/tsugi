...
class GoogleCloudContactcenterinsightsV1ConstraintEvaluationResult extends \Google\Collection
{
  ...
  protected $ruleConstraintResultsType = GoogleCloudContactcenterinsightsV1ConstraintEvaluationResultRuleConstraintResult::class;
   ...
   *
   * @param GoogleCloudContactcenterinsightsV1ConstraintEvaluationResultRuleConstraintResult[] $ruleConstraintResults
   */
  ...
  /**
   * @return GoogleCloudContactcenterinsightsV1ConstraintEvaluationResultRuleConstraintResult[]
   */
...
class_alias(GoogleCloudContactcenterinsightsV1ConstraintEvaluationResult::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1ConstraintEvaluationResult');
