...
class_alias(GoogleCloudContactcenterinsightsV1mainConversationDataSource::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1mainConversationDataSource');
