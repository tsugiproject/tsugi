...
class GoogleCloudContactcenterinsightsV1alpha1MetricValue extends \Google\Collection
{
  /**
...
class_alias(GoogleCloudContactcenterinsightsV1alpha1MetricValue::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1alpha1MetricValue');
