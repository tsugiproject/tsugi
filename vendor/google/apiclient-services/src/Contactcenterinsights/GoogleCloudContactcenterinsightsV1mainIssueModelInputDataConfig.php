...
class_alias(GoogleCloudContactcenterinsightsV1mainIssueModelInputDataConfig::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1mainIssueModelInputDataConfig');
