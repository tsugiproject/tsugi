...
class GoogleCloudContactcenterinsightsV1alpha1LossPatternLink extends \Google\Model
{
  /**
  ...
  protected $botInstructionLinkType = GoogleCloudContactcenterinsightsV1alpha1LossPatternLinkBotInstructionLink::class;
  protected $botInstructionLinkDataType = '';
  protected $conversationLinkType = GoogleCloudContactcenterinsightsV1alpha1LossPatternLinkConversationLink::class;
   ...
   *
   * @param GoogleCloudContactcenterinsightsV1alpha1LossPatternLinkBotInstructionLink $botInstructionLink
   */
  public function setBotInstructionLink(GoogleCloudContactcenterinsightsV1alpha1LossPatternLinkBotInstructionLink $botInstructionLink)
  {
    $this->botInstructionLink = $botInstructionLink;
  }
  /**
   * @return GoogleCloudContactcenterinsightsV1alpha1LossPatternLinkBotInstructionLink
   */
   ...
   *
   * @param GoogleCloudContactcenterinsightsV1alpha1LossPatternLinkConversationLink $conversationLink
   */
  public function setConversationLink(GoogleCloudContactcenterinsightsV1alpha1LossPatternLinkConversationLink $conversationLink)
  {
    $this->conversationLink = $conversationLink;
  }
  /**
   * @return GoogleCloudContactcenterinsightsV1alpha1LossPatternLinkConversationLink
   */
...
class_alias(GoogleCloudContactcenterinsightsV1alpha1LossPatternLink::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1alpha1LossPatternLink');
