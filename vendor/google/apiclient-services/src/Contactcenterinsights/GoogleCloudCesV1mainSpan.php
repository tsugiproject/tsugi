...
class GoogleCloudCesV1mainSpan extends \Google\Collection
{
   ...
   */
  public $attributes;
  protected $childSpansType = GoogleCloudCesV1mainSpan::class;
   ...
   *
   * @param GoogleCloudCesV1mainSpan[] $childSpans
   */
...
class_alias(GoogleCloudCesV1mainSpan::class, 'Google_Service_Contactcenterinsights_GoogleCloudCesV1mainSpan');
