...
class GoogleCloudContactcenterinsightsV1alpha1ConstraintEvaluationResult extends \Google\Collection
{
  ...
  protected $ruleConstraintResultsType = GoogleCloudContactcenterinsightsV1alpha1ConstraintEvaluationResultRuleConstraintResult::class;
   ...
   *
   * @param GoogleCloudContactcenterinsightsV1alpha1ConstraintEvaluationResultRuleConstraintResult[] $ruleConstraintResults
   */
  ...
  /**
   * @return GoogleCloudContactcenterinsightsV1alpha1ConstraintEvaluationResultRuleConstraintResult[]
   */
...
class_alias(GoogleCloudContactcenterinsightsV1alpha1ConstraintEvaluationResult::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1alpha1ConstraintEvaluationResult');
