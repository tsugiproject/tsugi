...
class GoogleCloudDiscoveryengineV1alphaReplacePatientFilterRequest extends \Google\Collection
{
   ...
   * requested DataStore already has a patient filter, an ALREADY_EXISTS error
   * will be returned.
   *
   * @var string
   */
   ...
   * patients for the new patient filter, in format `projects/{project_id}/locat
   * ions/{location_id}/datasets/{dataset_id}/fhirStores/{fhir_store_id}/fhir/Gr
   * oup/{group_id}`. if the caller does not have permission to access the FHIR
   * store, regardless of whether it exists, PERMISSION_DENIED error is
   ...
   * must be a FHIR resource name of type Group, and the new filter will be
...
class_alias(GoogleCloudDiscoveryengineV1alphaReplacePatientFilterRequest::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaReplacePatientFilterRequest');
