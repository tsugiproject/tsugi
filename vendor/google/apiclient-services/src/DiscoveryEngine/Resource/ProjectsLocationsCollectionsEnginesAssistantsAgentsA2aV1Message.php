 ...
 *   $message = $discoveryengineService->projects_locations_collections_engines_assistants_agents_a2a_v1_message;
 *  </code>
 */
class ProjectsLocationsCollectionsEnginesAssistantsAgentsA2aV1Message extends \Google\Service\Resource
{
  /**
...
class_alias(ProjectsLocationsCollectionsEnginesAssistantsAgentsA2aV1Message::class, 'Google_Service_DiscoveryEngine_Resource_ProjectsLocationsCollectionsEnginesAssistantsAgentsA2aV1Message');
