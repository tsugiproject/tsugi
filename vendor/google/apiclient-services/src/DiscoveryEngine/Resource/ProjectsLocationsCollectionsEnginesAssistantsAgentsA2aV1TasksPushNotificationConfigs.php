 ...
 *   $pushNotificationConfigs = $discoveryengineService->projects_locations_collections_engines_assistants_agents_a2a_v1_tasks_pushNotificationConfigs;
 *  </code>
 */
class ProjectsLocationsCollectionsEnginesAssistantsAgentsA2aV1TasksPushNotificationConfigs extends \Google\Service\Resource
{
  /**
   ...
   * igs.listProjectsLocationsCollectionsEnginesAssistantsAgentsA2aV1TasksPushNoti
   * ficationConfigs)
   *
   * @param string $tenant Optional tenant, provided as a path parameter.
   * Experimental, might still change for 1.0 release.
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsCollectionsEnginesAssistantsAgentsA2aV1TasksPushNotificationConfigs($tenant, $parent, $optParams = [])
  {
...
class_alias(ProjectsLocationsCollectionsEnginesAssistantsAgentsA2aV1TasksPushNotificationConfigs::class, 'Google_Service_DiscoveryEngine_Resource_ProjectsLocationsCollectionsEnginesAssistantsAgentsA2aV1TasksPushNotificationConfigs');
