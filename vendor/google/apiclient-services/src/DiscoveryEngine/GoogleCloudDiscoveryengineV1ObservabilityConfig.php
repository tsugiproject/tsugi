...
class GoogleCloudDiscoveryengineV1ObservabilityConfig extends \Google\Model
{
  /**
...
class_alias(GoogleCloudDiscoveryengineV1ObservabilityConfig::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1ObservabilityConfig');
