...
class GoogleCloudDiscoveryengineV1alphaEngineKnowledgeGraphConfig extends \Google\Collection
{
  ...
  protected $featureConfigType = GoogleCloudDiscoveryengineV1alphaEngineKnowledgeGraphConfigFeatureConfig::class;
   ...
   *
   * @param GoogleCloudDiscoveryengineV1alphaEngineKnowledgeGraphConfigFeatureConfig $featureConfig
   */
  public function setFeatureConfig(GoogleCloudDiscoveryengineV1alphaEngineKnowledgeGraphConfigFeatureConfig $featureConfig)
  {
    $this->featureConfig = $featureConfig;
  }
  /**
   * @return GoogleCloudDiscoveryengineV1alphaEngineKnowledgeGraphConfigFeatureConfig
   */
...
class_alias(GoogleCloudDiscoveryengineV1alphaEngineKnowledgeGraphConfig::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaEngineKnowledgeGraphConfig');
