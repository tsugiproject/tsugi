 ...
 *   $operations = $aiplatformService->skills_operations;
 *  </code>
 */
class SkillsOperations extends \Google\Service\Resource
{
  /**
   ...
   * (operations.listSkillsOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listSkillsOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(SkillsOperations::class, 'Google_Service_Aiplatform_Resource_SkillsOperations');
