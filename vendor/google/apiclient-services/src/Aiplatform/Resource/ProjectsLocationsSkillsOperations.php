 ...
 *   $operations = $aiplatformService->projects_locations_skills_operations;
 *  </code>
 */
class ProjectsLocationsSkillsOperations extends \Google\Service\Resource
{
  /**
   ...
   * (operations.listProjectsLocationsSkillsOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsSkillsOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsSkillsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsSkillsOperations');
