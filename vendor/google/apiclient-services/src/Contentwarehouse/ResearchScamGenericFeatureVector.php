...
class ResearchScamGenericFeatureVector extends \Google\Collection
{
  ...
  public $classLabel;
  /**
   * @var ResearchScamGenericFeatureVectorCrowding
   */
  public $crowding;
  ...
  /**
   * @var ResearchScamGenericFeatureVectorFixedPointMetadata
   */
