...
class AssistantApiCoreTypesRingtoneTaskMetadataOnDeviceAlarmMetadata extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AssistantApiCoreTypesRingtoneTaskMetadataOnDeviceAlarmMetadata::class, 'Google_Service_Contentwarehouse_AssistantApiCoreTypesRingtoneTaskMetadataOnDeviceAlarmMetadata');
