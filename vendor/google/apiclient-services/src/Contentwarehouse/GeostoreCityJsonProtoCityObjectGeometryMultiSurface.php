...
class GeostoreCityJsonProtoCityObjectGeometryMultiSurface extends \Google\Collection
{
  ...
  /**
   * @param GeostoreCityJsonProtoCityObjectGeometrySurface[]
   */
  ...
  /**
   * @return GeostoreCityJsonProtoCityObjectGeometrySurface[]
   */
...
class_alias(GeostoreCityJsonProtoCityObjectGeometryMultiSurface::class, 'Google_Service_Contentwarehouse_GeostoreCityJsonProtoCityObjectGeometryMultiSurface');
