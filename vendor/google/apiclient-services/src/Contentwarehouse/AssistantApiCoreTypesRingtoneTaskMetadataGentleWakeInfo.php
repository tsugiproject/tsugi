...
class AssistantApiCoreTypesRingtoneTaskMetadataGentleWakeInfo extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AssistantApiCoreTypesRingtoneTaskMetadataGentleWakeInfo::class, 'Google_Service_Contentwarehouse_AssistantApiCoreTypesRingtoneTaskMetadataGentleWakeInfo');
