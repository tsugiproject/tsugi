...
class GeostoreCurvatureProto extends \Google\Collection
{
  ...
  /**
   * @param GeostorePointCurvatureProto[]
   */
  public function setPointCurvature($pointCurvature)
  {
    $this->pointCurvature = $pointCurvature;
  }
  /**
   * @return GeostorePointCurvatureProto[]
   */
  public function getPointCurvature()
  {
    return $this->pointCurvature;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GeostoreCurvatureProto::class, 'Google_Service_Contentwarehouse_GeostoreCurvatureProto');
