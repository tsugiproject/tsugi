...
class UpdateDocumentTabPropertiesRequest extends \Google\Model
{
  /**
   * The fields that should be updated. At least one field must be specified.
   * The root `tab_properties` is implied and should not be specified. A single
...
class_alias(UpdateDocumentTabPropertiesRequest::class, 'Google_Service_Docs_UpdateDocumentTabPropertiesRequest');
