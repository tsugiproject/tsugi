...
class GoldengateOracleNosqlConnectionProperties extends \Google\Model
{
  /**
...
class_alias(GoldengateOracleNosqlConnectionProperties::class, 'Google_Service_OracleDatabase_GoldengateOracleNosqlConnectionProperties');
