...
class ActiveMinutesByActivityLevel extends \Google\Model
{
  /**
   ...
   * Required. Number of whole minutes spent in activity.
   *
   * @param string $activeMinutes
   */
  public function setActiveMinutes($activeMinutes)
  {
...
class_alias(ActiveMinutesByActivityLevel::class, 'Google_Service_GoogleHealthAPI_ActiveMinutesByActivityLevel');
