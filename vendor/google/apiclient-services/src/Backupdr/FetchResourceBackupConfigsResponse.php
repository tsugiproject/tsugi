...
class FetchResourceBackupConfigsResponse extends \Google\Collection
{
...
class_alias(FetchResourceBackupConfigsResponse::class, 'Google_Service_Backupdr_FetchResourceBackupConfigsResponse');
