 ...
 *   $resourceBackupConfigs = $backupdrService->organizations_locations_resourceBackupConfigs;
 *  </code>
 */
class OrganizationsLocationsResourceBackupConfigs extends \Google\Service\Resource
{
  /**
...
class_alias(OrganizationsLocationsResourceBackupConfigs::class, 'Google_Service_Backupdr_Resource_OrganizationsLocationsResourceBackupConfigs');
