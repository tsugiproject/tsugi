 ...
 *   $resourceBackupConfigs = $backupdrService->folders_locations_resourceBackupConfigs;
 *  </code>
 */
class FoldersLocationsResourceBackupConfigs extends \Google\Service\Resource
{
  /**
...
class_alias(FoldersLocationsResourceBackupConfigs::class, 'Google_Service_Backupdr_Resource_FoldersLocationsResourceBackupConfigs');
