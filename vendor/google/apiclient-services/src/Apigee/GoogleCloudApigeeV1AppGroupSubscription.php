...
class GoogleCloudApigeeV1AppGroupSubscription extends \Google\Model
{
  /**
...
class_alias(GoogleCloudApigeeV1AppGroupSubscription::class, 'Google_Service_Apigee_GoogleCloudApigeeV1AppGroupSubscription');
