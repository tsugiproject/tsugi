...
class GoogleCloudApigeeV1CreditAppGroupBalanceRequest extends \Google\Model
{
...
class_alias(GoogleCloudApigeeV1CreditAppGroupBalanceRequest::class, 'Google_Service_Apigee_GoogleCloudApigeeV1CreditAppGroupBalanceRequest');
