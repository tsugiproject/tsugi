...
class GoogleCloudApigeeV1AppGroupBalanceWallet extends \Google\Model
{
...
class_alias(GoogleCloudApigeeV1AppGroupBalanceWallet::class, 'Google_Service_Apigee_GoogleCloudApigeeV1AppGroupBalanceWallet');
