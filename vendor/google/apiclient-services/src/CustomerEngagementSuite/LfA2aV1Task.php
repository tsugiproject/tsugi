...
class LfA2aV1Task extends \Google\Collection
{
  protected $collection_key = 'history';
  protected $artifactsType = LfA2aV1Artifact::class;
   ...
   */
  public $contextId;
  protected $historyType = LfA2aV1Message::class;
   ...
   *
   * @param LfA2aV1Artifact[] $artifacts
   */
  ...
  /**
   * Required. The current status of a `Task`, including `state` and a
   * `message`.
   *
...
class_alias(LfA2aV1Task::class, 'Google_Service_CustomerEngagementSuite_LfA2aV1Task');
