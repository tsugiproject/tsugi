...
class DataStoreToolBoostSpecConditionBoostSpecBoostControlSpecControlPoint extends \Google\Model
{
  /**
...
class_alias(DataStoreToolBoostSpecConditionBoostSpecBoostControlSpecControlPoint::class, 'Google_Service_CustomerEngagementSuite_DataStoreToolBoostSpecConditionBoostSpecBoostControlSpecControlPoint');
