...
class DataStoreToolRewriterConfig extends \Google\Model
{
  /**
...
class_alias(DataStoreToolRewriterConfig::class, 'Google_Service_CustomerEngagementSuite_DataStoreToolRewriterConfig');
