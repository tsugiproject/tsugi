...
class RetrieveToolSchemaRequest extends \Google\Model
{
  /**
...
class_alias(RetrieveToolSchemaRequest::class, 'Google_Service_CustomerEngagementSuite_RetrieveToolSchemaRequest');
