...
class ListChangelogsResponse extends \Google\Collection
{
...
class_alias(ListChangelogsResponse::class, 'Google_Service_CustomerEngagementSuite_ListChangelogsResponse');
