...
class ToolCalls extends \Google\Collection
{
  protected $collection_key = 'toolCalls';
  protected $toolCallsType = ToolCall::class;
...
class_alias(ToolCalls::class, 'Google_Service_CustomerEngagementSuite_ToolCalls');
