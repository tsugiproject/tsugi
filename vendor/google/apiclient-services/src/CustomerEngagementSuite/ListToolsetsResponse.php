...
class ListToolsetsResponse extends \Google\Collection
{
...
class_alias(ListToolsetsResponse::class, 'Google_Service_CustomerEngagementSuite_ListToolsetsResponse');
