...
class ListGuardrailsResponse extends \Google\Collection
{
  protected $collection_key = 'guardrails';
...
class_alias(ListGuardrailsResponse::class, 'Google_Service_CustomerEngagementSuite_ListGuardrailsResponse');
