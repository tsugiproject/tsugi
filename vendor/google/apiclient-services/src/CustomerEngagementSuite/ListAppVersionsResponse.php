...
class ListAppVersionsResponse extends \Google\Collection
{
  protected $collection_key = 'appVersions';
...
class_alias(ListAppVersionsResponse::class, 'Google_Service_CustomerEngagementSuite_ListAppVersionsResponse');
