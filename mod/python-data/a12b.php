...
<ul>
<li> <a href="data/assn_12b_sample.txt" target="_blank">Download sample data</a> (Sum=<?= $sum_sample ?>) </li>
<li> <a href="data/assn_12b_actual.txt" target="_blank">Download the actual data</a> (Sum ends with <?= $sum%100 ?>)<br/> </li>
</ul>
