...
<link href="<?php echo(getLocalStatic(__FILE__)); ?>/static/splitter/jquery.splitter.css" rel="stylesheet"/>
<?php if ( $codemirror ) { ?>
<link href="<?php echo(getLocalStatic(__FILE__)); ?>/static/codemirror/codemirror.css" rel="stylesheet"/>
<script type="text/javascript" src="<?php echo(getLocalStatic(__FILE__)); ?>/static/codemirror/codemirror.js"></script>
<script type="text/javascript" src="<?php echo(getLocalStatic(__FILE__)); ?>/static/codemirror/python.js"></script>
<?php } ?>
...
$OUTPUT->footerStart();
?>
<script type="text/javascript" src="<?php echo(getLocalStatic(__FILE__)); ?>/static/splitter/jquery.splitter-0.14.0.js"></script>
<script type="text/javascript">
