...
class LogoutControllerTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Test that Logout::routes() registers routes correctly
     */
    public function testRoutesRegistersCorrectRoutes()
    {
        // Register routes
        Logout::routes($this->mockApp);
        ...
        $this->assertTrue($hasLogoutRoute, 'Should register /logout route');
    }
    ...
    {
        $this->assertEquals('/logout', Logout::ROUTE, 'ROUTE constant should be /logout');
    }
}
