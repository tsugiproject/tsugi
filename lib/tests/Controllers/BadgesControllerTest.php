...
require_once "src/Controllers/Badges.php";
require_once "src/Config/ConfigInfo.php";
require_once "src/Lumen/Application.php";
require_once "src/Lumen/Router.php";

use \Tsugi\Controllers\Badges;
use \Tsugi\Lumen\Application;

class BadgesControllerTest extends \PHPUnit\Framework\TestCase
{
    private $originalCFG;
    private $mockLaunch;
    private $mockApp;
    ...
    /**
     * Test that Badges::routes() registers routes correctly
     */
    public function testRoutesRegistersCorrectRoutes()
    {
        // Register routes
        Badges::routes($this->mockApp);
        ...
        $this->assertTrue($hasBadgesRoute, 'Should register /badges route');
    }
    ...
    {
        $this->assertEquals('/badges', Badges::ROUTE, 'ROUTE constant should be /badges');
    }
}
