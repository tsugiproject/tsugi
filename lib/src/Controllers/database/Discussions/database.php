...
// Discussions (tdiscus) tables used by Tsugi\Controllers\Discussions and the tdiscus tool.

$DATABASE_UNINSTALL = array(
"drop table if exists {$CFG->dbprefix}tdiscus_read",
"drop table if exists {$CFG->dbprefix}tdiscus_flag",
"drop table if exists {$CFG->dbprefix}tdiscus_mention",
"drop table if exists {$CFG->dbprefix}tdiscus_user_thread_participation",
