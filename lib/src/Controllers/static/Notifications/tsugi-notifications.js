    ...
    connectedCallback() {
        ...
        if ('BroadcastChannel' in window) {
            ...
            this.announcementsChannel.addEventListener('message', (event) => {
                if (event.data && event.data.type === 'announcement-dismissed') {
                    ...
                    <div class="popup-content">
                        ...
                        ` : html`
                            <div class="notification-list">
                                ...
                                ` : ''}
                                ${allItems.map(item => {
                                    // Use appropriate view URL based on item type
                                    const viewUrl = item.type === 'notification' 
                                        ? (item.url || this.notificationsViewUrl || '#')
                                        : (item.url || this.announcementsViewUrl || '#');
                                    return html`
