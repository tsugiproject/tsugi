...
/**
 * Sites switcher (Sakai waffle). Loads up to five recently visited
 * memberships after the flyout opens. The Google home course is omitted
 * unless it is the only site. Full list is /courses.
 *
 *   <tsugi-courses
...
class TsugiCourses extends LitElement {
    ...
    render() {
        return html`
            <button type="button" class="icon-wrap" @click=${this.togglePopup} title="Sites" aria-haspopup="true" aria-expanded=${this.popupOpen ? 'true' : 'false'}>
