...
class TsugiDiscussions extends LitElement {
    ...
    static styles = css`
        ...
        .badge { position: absolute; top: -0.2em; right: -0.4em; border-radius: 0.35em; padding: 0.12em 0.35em; font-size: 0.6em; font-weight: bold; line-height: 1.2; min-width: 0.9em; text-align: center; box-shadow: 0 0.05em 0.15em rgba(0,0,0,0.3); }
        .badge-personal { background-color: #d9534f; color: #fff; }
        .badge-participating { background-color: #fbbf24; color: #111; }
        .badge-global { background-color: #d1d5db; color: #111; }
    `;
