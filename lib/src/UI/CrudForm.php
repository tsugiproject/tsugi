...
class CrudForm {
     ...
     *     $query_fields = array(":UID" => U::loggedInUserId()); // lib/include/lms_lib.php (via config.php)
     ...
     *     (with :UID bound to U::loggedInUserId() from lms_lib.php)
     *
     ...
     * U::currentContextId() (see lms_lib.php) to the WHERE clause.
     *
