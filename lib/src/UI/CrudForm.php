...
class CrudForm {
     ...
     *     $query_fields = array(":UID" => ReqScope::loggedInUserId()); // lib/include/lms_lib.php (via config.php)
     ...
     *     (with :UID bound to ReqScope::loggedInUserId() from lms_lib.php)
     *
     ...
     * ReqScope::currentContextId() (see lms_lib.php) to the WHERE clause.
     *
