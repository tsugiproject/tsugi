...
UPDATE t_lti_key SET key_key=concat("key_",key_id), secret=concat("secret_",key_id),new_secret=null, settings=null, user_id=null, consumer_profile=null, new_consumer_profile=null;
UPDATE t_lti_context SET title=concat("Context Title ",context_id), context_key=concat("context_key_",context_id), settings_url=NULL, settings=NULL, json=NULL;
UPDATE t_lti_link SET title=concat("Link Title ",link_id), link_key=concat("link_key_",link_id), settings_url=NULL, settings=NULL,json=NULL;
UPDATE t_lti_result SET sourcedid=concat("sourcedid_",result_id), grade=RAND(),server_grade=NULL, json=NULL;
UPDATE t_lti_service SET service_key=concat("http://www.example.com/service_",service_id), json=NULL;
UPDATE t_lti_user SET user_key=concat("user_key_",user_id), displayname=concat("Displayname ", user_id),email=concat("user",user_id,"@example.com"),created_at=NOW(), updated_at=NOW(), login_at=NOW(),json=NULL;
