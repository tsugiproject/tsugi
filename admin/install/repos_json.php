...
try {
    ...
    */
    ...
    error_log('repos_json.php: '.$e->getMessage());
    $retval['status'] = 'ERROR';
    $retval['error'] = $e->getMessage();
    $retval['available'] = isset($available) ? $available : array();
    $retval['installed'] = isset($installed) ? $installed : array();
    $retval['required'] = isset($required) ? $required : array();
    echo(json_encode($retval, JSON_PRETTY_PRINT));
}
