...
$l->header();
if ( $show_analytics || ($use_lessons2 && !$l->isSingle() && $CFG->canAuthor() && $is_instructor) ) {
    ...
    // Show Author button if: using Lessons2, at top level (not in a module), author allowed, and instructor
    if ( $use_lessons2 && !$l->isSingle() && $CFG->canAuthor() && $is_instructor ) {
