...
This tool authors and delivers GIFT-authored quizzes using LTI.
Instructors can export a configured quiz to QTI 1.2 from the tool menu.

The standalone paste-in GIFT to QTI converter lives in a separate repo:
...
GIFT is a line-oriented quiz format from Moodle, handy because quizzes can live in GitHub:
