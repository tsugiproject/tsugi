...
Target profile: **IMS Common Cartridge 1.1/1.2/1.3 assessment profile of QTI 1.2.1**, not generic QTI 1.2 and not Canvas `question_type` metadata. Schema location:
...
Do **not** add LMS-specific export hacks until a real import failure is observed.
